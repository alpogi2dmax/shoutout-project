...
function UserSettingsReplyCard({reply}) {

    const { user, handleReplyLike, deleteReplyUser } = useContext(UserContext)
    const { handleReplyLikeComment, deleteReplyComment } = useContext(CommentContext)
...
export default UserSettingsReplyCard